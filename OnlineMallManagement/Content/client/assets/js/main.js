(function ($) {
  ...
  $('body').on('click', '.checkout-card .payment-option li', function () {
    $('.checkout-card .payment-option li').removeClass('active');
  ...
  $(document).ready(function () {
    ...
    $(".seat-free-two img").on('click', function(e) {
      if(bookTwo == 0) {
          $(this).attr("src","/Content/client/assets/images/movie/seat02-free.png");
        bookTwo = 1;
      }
      else if(bookTwo == 1) {
          $(this).attr("src","/Content/client/assets/images/movie/seat02-booked.png");
        bookTwo = 0;
      }
    });
